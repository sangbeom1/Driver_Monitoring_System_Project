...
class EyeDetector:
    ...
    def show_eye_keypoints(self, color_frame, landmarks, frame_size):
        ...
        cv2.circle(color_frame, tuple((landmarks[LEFT_IRIS_NUM, :2] * frame_size).astype(np.uint32)),
                   3, (255, 255, 255), cv2.FILLED, lineType=cv2.LINE_AA)
        ...
        for n in EYES_LMS_NUMS:
            ...
            cv2.circle(color_frame, (x, y), 1, (0, 0, 255), -1, lineType=cv2.LINE_AA)
